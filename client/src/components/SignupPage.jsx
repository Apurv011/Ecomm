        ...
        <div className="row">
          ...
          <div className="col-lg-6 mt-4 sign-main">
            ...
            <form className="from-group login-signup">
              <div className="mb-3">
                <label for="fname" className="form-label" style={{ color: "#ffffff"}}>
                  User Name
                </label>
                <input
              ...
              <div className="mb-3">
                <label for="email" className="form-label" style={{ color: "#ffffff"}}>
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="form-row">
                ...
                <div className="col-md-6 mb-3">
                  <label style={{ color: "#ffffff"}}>Re-Enter Password</label>
                  <input
                    id="rps"
                    type="password"
              ...
              <div className="mb-3">
                <label for="address" className="form-label" style={{ color: "#ffffff"}}>
                  Address
                </label>
                <textarea
                  onChange={handleChange}
            ...
            <Link to="/login">
              <h1 id="emailHelp" className="form-text small-text" style={{paddingBottom:"20px"}}>
